...
describe('[TC_LEARNER_25] Course about page: enroll in a course', function () {
  ...
  it('should display button "View Course"', function () {
    cy.visit(`${baseURL}/courses/${DEMO_COURSE_DATA.courseId}/about`)
...
describe('About course page tests for Staff', function () {
  ...
  describe('[TC_LEARNER_26] Course about page: share course by Facebook', function () {
    it('should visible facebook icon', function () {
      aboutCoursePage.getIconFacebook().should('be.visible')
    })
  })

  describe('[TC_LEARNER_27] Course about page: share course by Twitter', function () {
    it('should visible twitter icon', function () {
      aboutCoursePage.getIconTwitter().should('be.visible')
    })
  })

  describe('[TC_LEARNER_28] Course about page: share course by email', function () {
    it('should visible mail icon', function () {
      aboutCoursePage.getIconMail().should('be.visible')
    })
  })

  describe('[TC_LEARNER_29] Course about page: start date format', function () {
  ...
  describe('[TC_LEARNER_31] Course about page: course image & video', function () {
...
describe('About course page tests for Not authorized user', function () {
  const aboutCoursePage = new AboutCoursePage()
